...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { amount: @currency.amount, country: @currency.country, name: @currency.name } }, as: :json
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { amount: @currency.amount, country: @currency.country, name: @currency.name } }, as: :json
    assert_response 200
  end
